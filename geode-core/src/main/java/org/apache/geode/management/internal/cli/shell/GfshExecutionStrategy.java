...
public class GfshExecutionStrategy implements ExecutionStrategy {
   ...
   * {@link CliMetaData#requireLocalExecution()} set to <code>false</code>, {@link OperationInvoker} is used to
   ...
   * @return true if CliMetaData is added to the method & CliMetaData.requireLocalExecution is set to true,
   *         false otherwise
   */
